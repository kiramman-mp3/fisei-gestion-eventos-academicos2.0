            ...
            <div class="admin-section">
                ...
                <form id="formCategoria" class="admin-form">
                    <div class="admin-form-fields">
                        <div><input type="hidden" name="id" id="cat-id"><label for="cat-nombre"><span
                                    class="rojo">*</span>Nombre de la categoría</label><input type="text" name="nombre"
                                id="cat-nombre" required></div><button type="submit">Guardar Categoría</button>
                    </div>
                </form>
                <div>
    ...
    <script>
        ...
        function habilitarEdicionCategoria(id) {
            ...
            if (nombreCell && editButton && saveButton) {
                ...
                // Reemplaza el texto con un campo de entrada
